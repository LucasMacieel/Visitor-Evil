...
public class WeaponSpreadUI : MonoBehaviour {
	...
	void Start () {
		crosshair = transform.FindChild ("Crosshair").GetComponent<RectTransform> ();
		left = crosshair.FindChild ("Left").GetComponent<RectTransform> ();
		right = crosshair.FindChild ("Right").GetComponent<RectTransform> ();
		up = crosshair.FindChild ("Up").GetComponent<RectTransform> ();
		down = crosshair.FindChild ("Down").GetComponent<RectTransform> ();

		circular = transform.FindChild ("Circular").GetComponent<RectTransform> ();
